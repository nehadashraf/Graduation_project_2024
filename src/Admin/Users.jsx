...
import { Layout, Menu, Table, Avatar, Button, Tabs, Space, Input, Dropdown } from 'antd';
...
>
  ...
  const columnsDelivery = [
    ...
    },
    {
      ...
      render: (text, record) => (
        <Space>
          <Avatar src={record.deliveryApprovalImg} />
          {text}
        </Space>
      ),
    },
    ...
    },
    {
      ...
      dataIndex: 'startLoc',
      key: 'startLoc.coordinates',
      render: startLoc =>
        startLoc && startLoc.coordinates
